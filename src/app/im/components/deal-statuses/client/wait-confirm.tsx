...
function WaitConfirm({ chat }: IThisProps) {
  ...
  function ChangeStatusConfirmDoc() {
    ...
    ActionChangeStatusDealClient(chat.deal.id, "wait-doc-confirm", "client")
      .then(() => {
        addToast({
    ...
    <div className="top-item">
      ...
      <div className="txts">
        ...
        <div className="inf-texts">
          <span className="grey">Новая сделка, подтвердите или омтените</span>
        </div>
      </div>
      <div className="btns">
        <Button
